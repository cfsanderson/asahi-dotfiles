...
alias kbhypr='bat $HOME/Projects/keyboard-shortcuts/hyprland.md'
alias kbtmux='bat $HOME/Projects/keyboard-shortcuts/tmux.md'
alias kbaerc='bat $HOME/Projects/keyboard-shortcuts/aerc.md'
alias kbyazi='bat $HOME/Projects/keyboard-shortcuts/yazi.md'
alias kbrmpc='bat $HOME/Projects/keyboard-shortcuts/rmpc.md'
alias kbkhal='bat $HOME/Projects/keyboard-shortcuts/khal.md'
alias kbkitty='bat $HOME/Projects/keyboard-shortcuts/kitty.md'
alias kbgurk='bat $HOME/Projects/keyboard-shortcuts/gurk.md'
alias key='bat $HOME/Projects/keyboard-shortcuts/README.md'
alias l='ls -lAh'
alias la='ls -a'
alias mail='aerc'
...
alias pihole='ssh caleb@192.168.1.180'
alias rip='abcde'
alias signal='gurk'
...
alias ssh_personal-mbp='ssh personal-mbp'
...
alias yazikeys='bat $HOME/Projects/keyboard-shortcuts/yazi.md'
alias yt='yt-dlp'
